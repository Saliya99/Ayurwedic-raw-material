...
<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='#'"><span class="glyphicon glyphicon-edit pull-left"></span> Supplier </button></li>

  <li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='orders.php'"> <span class="glyphicon glyphicon-edit pull-left"></span> Oders </button></li>
  ...
  <ul class="dropdown-menu" style="width:240px">
    <li><a href="clothes_list.php"><strong>Raw matrial</strong> </a></li>
 <li><a href="cosmetics_list.php"><strong> Oil</strong></a></li>
   </ul></li>
