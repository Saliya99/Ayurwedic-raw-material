...
<body>
  <?php include("include/header.php");?>
	...
	<h1>Raw Metrial/ Page <?php echo $page;?> </h1></div><br>
...
$result=mysqli_query($connection,"select product_id,image, product_name,price from products  where product_type like '%raw%' order by time Desc Limit $page1,10")or die ("query 1 incorrect.....");
